...
[`@aws-sdk/client-kendra-ranking`](https://www.npmjs.com/package/@aws-sdk/client-kendra-ranking/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kendra-ranking@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RgljMDQCWLMv44so1wxu+1sIBkDIlXQIJrPiIMGeZA3ezAr5s6ATH7NB2TILTQFa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kendra-ranking": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kendra-ranking@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kendra-ranking@3.882.0/index.min.mjs": "sha384-RgljMDQCWLMv44so1wxu+1sIBkDIlXQIJrPiIMGeZA3ezAr5s6ATH7NB2TILTQFa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kendra-ranking/blob/refs/tags/3.882.0/LICENSE
```
