...
[`@aws-sdk/client-kendra-ranking`](https://www.npmjs.com/package/@aws-sdk/client-kendra-ranking/v/3.1034.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kendra-ranking@3.1034.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PyIHrCVnW21XRVPt3s2NBEbw6n0x7PxDfHL5sYjgoekOpKEKVO+0lCmFFHZeG22V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kendra-ranking": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kendra-ranking@3.1034.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kendra-ranking@3.1034.0/index.min.mjs": "sha384-PyIHrCVnW21XRVPt3s2NBEbw6n0x7PxDfHL5sYjgoekOpKEKVO+0lCmFFHZeG22V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kendra-ranking/blob/refs/tags/3.1034.0/LICENSE
```
